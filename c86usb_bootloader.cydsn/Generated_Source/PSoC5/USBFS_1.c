...
uint8 USBFS_1_initVar = 0u;
    ...
    {   0u,
        USBFS_1_ep1_TD_TERMOUT_EN,
        USBFS_1_ep2_TD_TERMOUT_EN,
        USBFS_1_ep3_TD_TERMOUT_EN,
        USBFS_1_ep4_TD_TERMOUT_EN,
        USBFS_1_ep5_TD_TERMOUT_EN,
        USBFS_1_ep6_TD_TERMOUT_EN,
        USBFS_1_ep7_TD_TERMOUT_EN,
        USBFS_1_ep8_TD_TERMOUT_EN
    };
            ...
            if (pData != NULL)
            {
                ...
                */
                ...
                (void) CyDmaTdSetAddress(USBFS_1_DmaNextTd[epNumber],  LO16((uint32)&clearInDataRdyStatus),
                                                                LO16((uint32)(USBFS_1_ARB_EP1_CFG_IND + ri)));
            ...
            else
            {
                ...
                if(length > 0u)
                {
                    ...
                    (void) CyDmaTdSetConfiguration(
                        ...
                        USBFS_1_DmaNextTd[epNumber], TD_TERMIN_EN | TD_INC_SRC_ADR );
                    (void) CyDmaTdSetAddress(USBFS_1_DmaTd[epNumber],
                                             LO16((uint32)USBFS_1_inDataPointer[epNumber]), LO16((uint32)p));
                    /* Clear Any potential pending DMA requests before starting the DMA channel to transfer data */
                    (void) CyDmaClearPendingDrq(USBFS_1_DmaChan[epNumber]);
                    /* Enable the DMA */
                    (void) CyDmaChSetInitialTd(USBFS_1_DmaChan[epNumber], USBFS_1_DmaTd[epNumber]);
                    ...
                    #ifndef USBFS_1_MANUAL_IN_EP_ARM
